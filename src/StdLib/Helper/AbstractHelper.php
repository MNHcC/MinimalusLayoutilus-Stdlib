...
namespace MNHcC\MinimalusLayoutilus\StdLib\Helper {
    ...
    use MNHcC\MinimalusLayoutilus\StdLib\PrototypeInterface;
    use MNHcC\MinimalusLayoutilus\StdLib\PrototypeTrait;
     ...
     */
    abstract class AbstractHelper implements PrototypeInterface {
...
//	}
	...
	public static function setSelfDetectMethodFilter($selfDetectMethodFilter) {
	    if(!AbstractHelper::isArray($selfDetectMethodFilter)) {		
